...
(function() {
    ...
    .factory("$cordovaOauth", ["$q", '$http', "$cordovaOauthUtility", "$rootScope", function($q, $http, $cordovaOauthUtility, $rootScope) {
        ...
        return {
            ...
            google: function(clientId, appScope, options) {
                ...
                if (window.cordova) {
                    ...
                    if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                        ...
                        var browserRef = window.open('https://accounts.google.com/o/oauth2/auth?client_id=' + clientId + '&redirect_uri=' + redirect_uri + '&scope=' + appScope.join(" ") + '&approval_prompt=force&response_type=token', '_blank', 'location=no,clearsessioncache=yes,clearcache=yes,hidden=yes');
                        browserRef.addEventListener("loadstart", function(event) {
            ...
            facebook: function(clientId, appScope, options) {
                ...
                if (window.cordova) {
                    ...
                    if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                        ...
                        var browserRef = window.open(flowUrl, '_blank', 'location=no,clearsessioncache=yes,clearcache=yes,hidden=yes');
                        ...
                        browserRef.addEventListener('error', function(event) {
                            $rootScope.hideSpinner();
                        });
            ...
            twitter: function(clientId, clientSecret, options) {
                ...
                if (window.cordova) {
                    ...
                    if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                        //var redirect_uri = "http://localhost/callback";
                        var redirect_uri = "http://twitter.com/";
                        if (options !== undefined) {
                            if (options.hasOwnProperty("redirect_uri")) {
                                redirect_uri = options.redirect_uri;
                            }
                        ...
                        if (typeof jsSHA !== "undefined") {
                            ...
                            $http({
                                ...
                                .success(function(requestTokenResult) {
                                    ...
                                    var browserRef = window.open('https://api.twitter.com/oauth/authenticate?oauth_token=' + parameterMap.oauth_token, '_blank', 'location=no,clearsessioncache=yes,clearcache=yes,hidden=yes');
                                    browserRef.addEventListener('loadstart', function(event) {
